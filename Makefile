...
test-install:
	-PGPASSWORD=postgres createuser rickover --host localhost --superuser --createrole --createdb --inherit -U postgres
	-PGPASSWORD=postgres createdb rickover --host localhost --owner=rickover -U postgres
	-PGPASSWORD=postgres createdb rickover_test --host localhost --owner=rickover -U postgres
